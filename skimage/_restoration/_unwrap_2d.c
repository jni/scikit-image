...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/Users/jni/projects/scikit-image/skimage/restoration/_unwrap_2d.pyx"
        ]
    },
...
static PyObject *__pyx_pw_7skimage_11restoration_10_unwrap_2d_1unwrap_2d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("unwrap_2d (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mask)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 5, 5, 1); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_unwrapped_image)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 5, 5, 2); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_wrap_around)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 5, 5, 3); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 5, 5, 4); __PYX_ERR(0, 14, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "unwrap_2d") < 0)) __PYX_ERR(0, 14, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_mask = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mask.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_unwrapped_image = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_unwrapped_image.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_wrap_around = values[3];
    __pyx_v_seed = values[4];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_7skimage_11restoration_10_unwrap_2d_unwrap_2d(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_mask, __Pyx_memviewslice __pyx_v_unwrapped_image, PyObject *__pyx_v_wrap_around, PyObject *__pyx_v_seed) {
  ...
  /* "skimage/restoration/_unwrap_2d.pyx":26
 * 
 ...
 */
  ...
  /* "skimage/restoration/_unwrap_2d.pyx":27
 *     # convert from python types to C types so we can release the GIL
 *     use_seed = seed is None
 *     cseed = 0 if seed is None else seed             # <<<<<<<<<<<<<<
 *     wrap_around_y, wrap_around_x = wrap_around
 ...
 */
  ...
  if ((__pyx_t_1 != 0)) {
    ...
    __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_v_seed); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L1_error)
    __pyx_t_2 = __pyx_t_3;
  }
  __pyx_v_cseed = __pyx_t_2;

  /* "skimage/restoration/_unwrap_2d.pyx":28
 *     use_seed = seed is None
 *     cseed = 0 if seed is None else seed
 *     wrap_around_y, wrap_around_x = wrap_around             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  if ((likely(PyTuple_CheckExact(__pyx_v_wrap_around))) || (PyList_CheckExact(__pyx_v_wrap_around))) {
    ...
    Py_ssize_t index = -1;
    __pyx_t_6 = PyObject_GetIter(__pyx_v_wrap_around); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 28, __pyx_L1_error)
  ...
  __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_4); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_5); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_wrap_around_y = __pyx_t_8;
  __pyx_v_wrap_around_x = __pyx_t_9;

  /* "skimage/restoration/_unwrap_2d.pyx":29
 *     cseed = 0 if seed is None else seed
 *     wrap_around_y, wrap_around_x = wrap_around
 *     with nogil:             # <<<<<<<<<<<<<<
 *         unwrap2D(&image[0, 0],
 ...
 *               double[:, ::1] unwrapped_image,
 */
  __pyx_tuple__19 = PyTuple_Pack(9, __pyx_n_s_image, __pyx_n_s_mask, __pyx_n_s_unwrapped_image, __pyx_n_s_wrap_around, __pyx_n_s_seed, __pyx_n_s_cseed, __pyx_n_s_use_seed, __pyx_n_s_wrap_around_x, __pyx_n_s_wrap_around_y); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_skimage_restoration__unwrap_2d_p, __pyx_n_s_unwrap_2d, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 *               double[:, ::1] unwrapped_image,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7skimage_11restoration_10_unwrap_2d_1unwrap_2d, NULL, __pyx_n_s_skimage_restoration__unwrap_2d); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_unwrap_2d, __pyx_t_1) < 0) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
